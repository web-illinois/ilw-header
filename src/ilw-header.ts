...
export class Header extends LitElement {
  ...
  connectedCallback() {
    ...
    renderBlockI() {
        return html`
      <svg xmlns="http://www.w3.org/2000/svg" role="img" alt="Block I" viewBox="0 0 24 34.67">
        <path class="outline"
    ...
    renderWordmark() {
        return html`<svg xmlns="http://www.w3.org/2000/svg" role="img" alt="University of Illinois Urbana-Champaign" viewBox="0 0 378.6 10.1">
